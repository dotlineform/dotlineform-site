...
def install_modal_fixture(page) -> None:
    page.evaluate(
        """async () => {
            ...
            `;
            const module = await import('/analytics/app/frontend/js/tag-aliases-modals.js');
...
def main() -> int:
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            page.locator('[data-role="edit-modal"] .analyticsModal__backdrop').click(position={"x": 4, "y": 4})
            ...
            open_direct_modal(
                page,
                "patchOpener",
                "smoke.module.showTagAliasesPatchModal(smoke.state, 'diff --git a/analytics-app/data/canonical/tag-aliases.json b/analytics-app/data/canonical/tag-aliases.json');",
            )
