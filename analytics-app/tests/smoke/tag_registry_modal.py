    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            open_direct_modal(
                page,
                "patchOpener",
                "smoke.module.showTagRegistryPatchModal(smoke.state, 'diff --git a/analytics-app/data/canonical/tag-registry.json b/analytics-app/data/canonical/tag-registry.json');",
            )
