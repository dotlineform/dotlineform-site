...
PROFILE_COMMANDS: dict[str, tuple[CheckCommand, ...]] = {
    ...
    "studio-smoke": (
        ...
        CheckCommand(
            ...
            "Legacy focused smoke for the Catalogue Series confirmation route shell; do not extend for routine modal UI changes.",
        ),
        CheckCommand(
    ...
    "analytics-smoke": (
        ...
        CheckCommand(
            ...
            "Legacy focused smoke for Analytics tag registry shell contracts; prefer API or module tests for new behavior.",
        ),
        CheckCommand(
            ...
            "Legacy focused smoke for Analytics tag aliases shell contracts; prefer API or module tests for new behavior.",
        ),
        CheckCommand(
        ...
        CheckCommand(
            ...
            "Legacy focused smoke for Analytics series tags shell contracts; prefer API or module tests for new behavior.",
        ),
        CheckCommand(
            ...
            "Legacy focused smoke for Analytics series tag editor shell contracts; prefer API or module tests for new behavior.",
        ),
        CheckCommand(
        ...
        CheckCommand(
            ...
            "Smoke-check the local Analytics Data Sharing prepare route shell and mocked API response path.",
        ),
        CheckCommand(
            ...
            "Smoke-check the local Analytics Data Sharing review route shell and mocked API response path.",
        ),
        CheckCommand(
