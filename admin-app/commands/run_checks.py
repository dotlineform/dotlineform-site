...
PROFILE_COMMANDS: dict[str, tuple[CheckCommand, ...]] = {
    ...
    "quick": (
        ...
        CheckCommand(
            ...
            (
                ...
                "studio/services/tags/tag_document_bootstrap.py",
                "studio/services/tags/tag_flat_identity_migration.py",
                "studio/services/tags/tag_registry_label_retirement.py",
                ...
                "studio/services/tags/tag_source_paths.py",
                "studio/services/tags/tag_source_model.py",
                "studio/services/tags/tag_write_transactions.py",
                "studio/commands/bootstrap_tag_documents.py",
                "studio/commands/migrate_flat_tag_identity.py",
                "studio/commands/retire_tag_registry_label.py",
                ...
                "studio/tests/smoke/local_studio_tag_server.py",
                ...
                "studio/tests/python/test_tag_document_bootstrap.py",
                "studio/tests/python/test_tag_flat_identity_migration.py",
                "studio/tests/python/test_tag_registry_label_retirement.py",
                ...
                "studio/tests/python/test_studio_tags_api.py",
    ...
    "docs-viewer-smoke": (
        ...
        CheckCommand(
            ...
            (
                sys.executable,
                "docs-viewer/tests/smoke/docs_viewer_theme_modules.py",
                "--site-root",
                str(REPO_ROOT),
            ),
        ...
        CheckCommand(
            "docs-viewer-review-package-workflow-module-smoke",
            (
                sys.executable,
                "docs-viewer/tests/smoke/docs_viewer_review_package_workflow_modules.py",
                "--site-root",
            ...
            "Smoke-check scope-owned reviewable-package listing, two-column modal projection, and fail-closed ready/busy behavior.",
        ),
        CheckCommand(
