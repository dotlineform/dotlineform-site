#!/usr/bin/env python3
"""Smoke-check the Admin-hosted UI Catalogue modal shell demo."""
...
def start_admin_server() -> tuple[AdminAppServer, str]:
...
def run_viewport_smoke(page: Page, base_url: str, viewport: dict[str, int], timeout_ms: int) -> dict[str, object]:
    ...
    page.goto(route_url(base_url, "/admin/ui-catalogue/demos/primitives/modal-shell/"), wait_until="domcontentloaded")
...
def main() -> int:
    ...
    if not base_url:
        server, base_url = start_admin_server()
