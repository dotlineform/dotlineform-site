...
permalink: /admin/ui-catalogue/demos/primitives/panel/
...
{% capture image_markup %}<a
  ...
  href="#"
  style="--ui-demo-panel-image: url('/admin/ui-catalogue/assets/img/moments/blue-sky-thumb-96.webp');"
>
...
<div class="uiCatalogueDemoGrid">
  ...
  <section class="uiCatalogueDemoExample">
    ...
    <a
      ...
      href="#"
      style="--ui-demo-panel-image: url('{{ '/admin/ui-catalogue/assets/img/moments/blue-sky-thumb-96.webp' | relative_url }}');"
    >
      <h4 class="uiCatalogueDemoPanel__heading">Image Panel Link</h4>
