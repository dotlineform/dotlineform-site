---
doc_id: d-20260523-203756-b41c00
title: Local Setup Public Site Preview
added_date: 2026-05-23 20:37:56
...
Public-only CSS, JavaScript, route HTML, and other site-owned assets are edited directly under `site/`. Shared/public Docs Viewer JavaScript and stylesheets are canonical under `docs-viewer/`; after changing a represented canonical file, run `bin/site-code-update` and inspect its tracked `site/docs-viewer/` delta before previewing. Rerun `bin/site-code-update --check` and `bin/site-validate` when deploy readiness matters.
...
`site-tools/config/site-tools.json` owns deploy-root validation requirements and durable site-level settings used by local Python tooling. `site-tools/config/site-code-update.json` owns the explicit shared/public Docs Viewer runtime projection inventory.
...
- [Local Setup](/docs/?scope=studio&doc=d-20260413-000000-d314b7)
- [Local Studio Runner](/docs/?scope=studio&doc=d-20260422-174736-9bd0fc)
- [Local Studio App](/docs/?scope=studio&doc=d-20260522-080600-a2b102)
- [GitHub Actions](/docs/?scope=studio&doc=d-20260612-153500-7eadc8)
