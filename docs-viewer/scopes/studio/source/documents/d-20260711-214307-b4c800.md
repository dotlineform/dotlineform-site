...
[Docs Import](/docs/?scope=studio&doc=d-20260424-000000-fc8b5d) owns import of the immutable staged JSONL associated with a review package. Managed import lets the user create, explicitly overwrite, or skip records; it never treats the derived preview Markdown as import input.
