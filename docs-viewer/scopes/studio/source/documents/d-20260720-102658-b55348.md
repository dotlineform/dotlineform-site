...
last_updated: "2026-07-20 13:17:56"
ui_status: proposed
...
flowchart LR
    ...
    accDescr: Inline source passes through the local Docs Viewer and becomes a rendered diagram.
...
flowchart LR
    ...
    accDescr: Canonical Markdown becomes a generated code block. A local scope loads the browser renderer and replaces it with an inline SVG host, while unsupported scopes retain readable source.
    source["Canonical Markdown fence"] --> payload["Generated code block"]
    payload --> gate{"Active scope is local?"}
