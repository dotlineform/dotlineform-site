...
| `local_external` | render in the managed reader | shipped | inline fence or Mermaid-to-SVG media |
...
The [delivery](/docs/?scope=studio&doc=d-20260720-102658-7de33d) records the shipped runtime, managed-local parity, public exclusion, and export boundary.
