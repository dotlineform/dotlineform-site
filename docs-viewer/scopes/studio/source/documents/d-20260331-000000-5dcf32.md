---
doc_id: d-20260331-000000-5dcf32
title: Search
...
- [Catalogue Search](/docs/?scope=studio&doc=d-20260602-160839-4ebe27) serves `/catalogue/search/` for public works and series.
- [Docs Viewer Search](/docs/?scope=studio&doc=d-20260602-160839-6d3cbb) is embedded in Docs Viewer routes such as `/docs/` and `/analysis/`.
...
Use [Search Build Pipeline](/docs/?scope=studio&doc=d-20260519-210908-69d0e9) for commands and the source-to-runtime flow.
...
The mechanics review belongs to [Search Mechanics](/docs/?scope=studio&doc=d-20260715-092247-6bbb5e), not to the current architecture pages.
