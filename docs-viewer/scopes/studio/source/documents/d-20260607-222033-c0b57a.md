...
- logs completed create, metadata, move, delete, and lifecycle actions when plans request it
...
Purpose: mutation planner for source doc create, metadata, move, and delete workflows.
...
- rejects publication fields from ordinary metadata changes
