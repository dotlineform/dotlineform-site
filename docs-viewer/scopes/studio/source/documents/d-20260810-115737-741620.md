...
last_updated: "2026-08-10 12:43:35"
...
WRK-1 does not add grouping, a Work projection, coverage percentages, automatic exception labels, saved output, arbitrary filters, or public display. Search, sorting controls, and clipboard transforms require an explicit later product decision if the basic report demonstrates a need.
