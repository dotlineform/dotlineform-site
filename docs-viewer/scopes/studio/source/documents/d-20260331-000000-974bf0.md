...
coverage/status, links into the one-series editor, and manages the structured
offline assignment session.

The page does not directly edit table rows. Editing happens in
[Series Tag Editor](/docs/?scope=studio&doc=d-20260331-000000-643429); this
route aggregates staged changes and reconciles them with canonical assignments.
...
The route uses Studio ready/busy state; preview/apply are busy commands and
session/import modal state is reflected in route mode.
