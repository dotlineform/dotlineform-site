...
- indexes every local document, while publish-capable collections omit `publishable: false` documents and excluded descendants from their public search projection
