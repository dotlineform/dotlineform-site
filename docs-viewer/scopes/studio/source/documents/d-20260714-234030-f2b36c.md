...
Processing is the first proving case. Its Markdown should remain in `docs-viewer/source/processing/documents/`, while source sketches, libraries, archives, spreadsheets, images, and recovered material may be numerous, large, or independently useful. The I Ching collection is a later scale test.
