...
ui_status: done
summary: Shipped placement language for checked-document, tree, document, context, and scope controls.
...
[Copy And Move Documents Between Scopes](/docs/?scope=studio&doc=d-20260716-193410-6d4efe) owns the shipped cross-scope workflow. [Create And Import Endpoints](/docs/?scope=studio&doc=d-20260607-222033-78a47c) owns its server contract.
