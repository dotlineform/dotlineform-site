...
```bash
$HOME/miniconda3/bin/python3 tests/audits/route_ready_state.py --strict --app admin
```

Valid IDs come from `APP_CONFIGS` in the script. `--json` is the structured mode used by the [Audit Runner](/docs/?scope=studio&doc=d-20260607-000000-fc2912).
