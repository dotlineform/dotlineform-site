...
The policy affects Catalogue route behaviour, not record construction or relevance. `studio/services/catalogue/search/build_search.py` builds the flat published Work/Series projection directly from canonical Catalogue source; it does not read public list or exact-record outputs. Build dependencies live in [Catalogue Search Build Config](/docs/?scope=studio&doc=d-20260425-154733-c6062c); ranking lives in `catalogue-search-runtime.js`.
