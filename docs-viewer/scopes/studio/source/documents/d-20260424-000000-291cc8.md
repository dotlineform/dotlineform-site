---
doc_id: d-20260424-000000-291cc8
title: Overview
...
The exact enabled features and current scope list live in `docs-viewer/config/routes/docs-viewer-routes.json` and `docs-viewer/config/scopes/docs_scopes.json`. [Configuration And Extension Points](/docs/?scope=studio&doc=d-20260512-142027-54b354) explains how those files interact with code registries and live capabilities.

## Three Surfaces

| surface | purpose | authority boundary |
| --- | --- | --- |
| Public routes | Read published Analysis content. | Static route config and published generated payloads; no local management services. |
...
[Runtime](/docs/?scope=studio&doc=d-20260331-000000-c313fd) owns the detailed boundary. [Docs Review](/docs/?scope=studio&doc=d-20260711-214307-b4c800) owns the returned-package workflow.
...
- [Source Organisation](/docs/?scope=studio&doc=d-20260423-000000-8fd731) for source roots and hierarchy
- [Builder](/docs/?scope=studio&doc=d-20260423-000000-c9f3ea) for build and publish commands
- [Generated Data Contracts](/docs/?scope=studio&doc=d-20260605-125108-c68916) for payload and read ownership
- [Runtime Module Ownership](/docs/?scope=studio&doc=d-20260605-125108-1d1ef3) for grouped browser-code responsibility
- [Management Endpoints](/docs/?scope=studio&doc=d-20260607-222033-647b52) for local HTTP ownership
...
- canonical public-safe reader runtime: `docs-viewer/runtime/js/shared/`
- canonical route-specific browser code: `docs-viewer/runtime/js/{public,management,review}/`
- canonical shared/public and local-only stylesheets: `docs-viewer/static/css/`
- tracked static deployment projection of the explicit public subset: `site/docs-viewer/`
- local services: `docs-viewer/services/`
- builders: `docs-viewer/build/`
- contract and boundary checks: `docs-viewer/tests/`

Use [Runtime Module Ownership](/docs/?scope=studio&doc=d-20260605-125108-1d1ef3) to choose a responsibility area, then search the code for the exact modules. This overview should change only when the architectural model changes, not whenever a helper is added or renamed.
