...
Main consumers load it through `studio/shared/python/pipeline_config.py`, including catalogue generation/build media, the standalone srcset builder, R2 publishing, project-media selection, and site consistency checks.
