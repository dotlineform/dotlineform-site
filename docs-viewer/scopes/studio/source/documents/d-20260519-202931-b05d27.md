...
| `site/assets/series/index/<series_id>.json` | selected Series metadata, optional rendered prose, and derived public document URLs | Series selection runtime |
