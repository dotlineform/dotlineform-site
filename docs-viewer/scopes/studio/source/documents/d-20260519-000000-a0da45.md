...
Canonical JSON files use a stable schema header and deterministic record ordering. Volatile write timestamps do not belong in source files; service and operation logs record operational time.
