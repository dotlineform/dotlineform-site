---
doc_id: d-20260711-012238-814555
title: Knowledge System Vision
added_date: "2026-07-11 01:22:38"
last_updated: "2026-08-14 17:06:50"
...
An Analysis document may begin as a ChatGPT output, be edited by a person, gain catalogue-derived semantic content, return to ChatGPT for further development, and later be accepted as a new canonical version.
...
Document identity, parent-child organization, summaries, tags, semantic-token relationships, and links provide navigable structure across a collection.

Those relationships should also support a navigable graph projection connecting documents to catalogue Works, Series, Moments, tags, and other registered entities. The graph is another view over canonical identities and generated relationships, not a separate knowledge store.
...
- Prefer typed semantic tokens to duplicated catalogue facts when live projection is intended.
...
- full source-and-asset Docs Viewer document packages
