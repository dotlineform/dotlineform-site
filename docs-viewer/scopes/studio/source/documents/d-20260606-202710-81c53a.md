---
doc_id: d-20260606-202710-81c53a
title: Local Admin App
added_date: "2026-06-06 20:27:10"
...
- asset version;
- local output-path metadata for Checks and Testing.
...
- `var/test-runs/` — check-profile summaries/logs;
