...
**In progress. DSU-P1 through DSU-P3 are complete; DSU-P4 has not started.** This is the first chosen delivery from the [Index Multiple Selection Consumer Assessment](/docs/?scope=studio&doc=d-20260722-000158-9c0f3e).
...
Review and explicitly approve DSU-P4 before final verification, the action-specific user document, owner-doc closeout, or delivery completion. Do not begin the Returned Packages redesign or another selection consumer as part of this delivery.
