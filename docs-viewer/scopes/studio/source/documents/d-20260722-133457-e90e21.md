...
**In progress. DSU-P1 and DSU-P2 are complete; DSU-P3 has not started.** This is the first chosen delivery from the [Index Multiple Selection Consumer Assessment](/docs/?scope=studio&doc=d-20260722-000158-9c0f3e).
...
- [ ] Move the existing `prepare-document-package` activity attribution from the retired route control to the manage Action without adding a second action id or duplicate registry entry.
...
Review and explicitly approve DSU-P3 before removing the dedicated Prepare route or any links to it. Do not begin the Returned Packages redesign or another selection consumer as part of this delivery.
