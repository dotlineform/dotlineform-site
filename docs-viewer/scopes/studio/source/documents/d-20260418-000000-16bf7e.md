...
Draft Works and Series remain canonical/Studio-only. Public lean indexes, exact Work/Series payloads, Recent, and Catalogue Search contain published records only; unpublishing or deleting a record removes its exact public projection through the existing build or cleanup owner.
