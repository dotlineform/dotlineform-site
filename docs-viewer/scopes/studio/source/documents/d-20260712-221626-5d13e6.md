...
summary: Proposed shared scope eligibility for future workspace-specific views, modes, and controls; the former Analysis semantic-picker use case is retired.
---
...
The former Analysis `semantic-token-picker` use case was retired by Catalogue
Token CT-P1. The remaining motivating example is a future Moments axis editor;
revalidate this proposal against that delivery before implementation.
