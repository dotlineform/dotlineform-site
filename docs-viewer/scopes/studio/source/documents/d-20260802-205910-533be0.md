...
| `site/assets/data/{series_index,works_index,recent_index}.json` and `site/assets/{series,works}/index/<id>.json` | generated public projection | Catalogue generation plus exact Docs enrichment from `docs_catalogue_document_urls.py` | public catalogue routes | scoped Catalogue build or exact Docs publication/Delete follow-through |
