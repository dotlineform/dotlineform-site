...
last_updated: "2026-08-05 23:23:04"
...
Physical folders, working documents, canonical Works/Series, and public editorial documents remain independent evidence. Project State observes disagreement and never repairs, renames, deletes, publishes, synchronizes them, or supplies a document-build relationship lookup. The current resolver-only persisted lookup is an unused implementation residue scheduled for removal before SSP-2 recloses.
