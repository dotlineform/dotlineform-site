...
last_updated: "2026-08-09 12:09:25"
...
| Library docs | `docs-viewer/scopes/library/source/documents/*.md` | `site/assets/data/docs/scopes/library/`, `site/assets/data/search/library/index.json`, `/library/` | local manage-mode access to `docs-viewer/scopes/library/published/documents/` and `docs-viewer/scopes/library/published/search/`, plus Data Sharing working output under `$DOTLINEFORM_PROJECTS_BASE_DIR/data-sharing/` | [Public Scopes](/docs/?scope=studio&doc=d-20260331-000000-f992b9) |
