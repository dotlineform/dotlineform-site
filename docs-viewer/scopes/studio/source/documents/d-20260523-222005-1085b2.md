...
| --- | --- | --- | --- | --- |
| Studio docs | `docs-viewer/source/studio/documents/*.md` | none by default | `docs-viewer/published/docs/studio/`, `docs-viewer/published/search/studio/index.json`, `<DOCS_VIEWER_BASE_URL>/docs/` manage payload reads | [Studio Overview](/docs/?scope=studio&doc=d-20260715-084611-ae9636), [Docs Viewer Builder](/docs/?scope=studio&doc=d-20260423-000000-c9f3ea) |
| Library docs | `docs-viewer/source/library/documents/*.md` | `site/assets/data/docs/scopes/library/`, `site/assets/data/search/library/index.json`, `/library/` | local manage-mode access to `docs-viewer/published/docs/library/` and `docs-viewer/published/search/library/`, plus Data Sharing working output under `$DOTLINEFORM_PROJECTS_BASE_DIR/data-sharing/` | [Public Scopes](/docs/?scope=studio&doc=d-20260331-000000-f992b9) |
| Analysis docs | `docs-viewer/source/analysis/documents/*.md` | `site/assets/data/docs/scopes/analysis/`, `site/assets/data/search/analysis/index.json`, `/analysis/` | local manage-mode access to `docs-viewer/published/docs/analysis/` and `docs-viewer/published/search/analysis/` | [Public Scopes](/docs/?scope=studio&doc=d-20260331-000000-f992b9) |
...
| Family | Canonical Source | Public Projection | Studio Projection | Owner |
| --- | --- | --- | --- | --- |
| Tag vocabulary and assignments | `analytics-app/data/canonical/tag-registry.json`, `tag-aliases.json`, `tag-assignments.json`, `tag-groups.json` | none by default; public catalogue search does not consume Analytics tags | local analytics API read/write payloads and tag route templates | [Analytics](/docs/?scope=studio&doc=d-20260506-181900-d08dbe) |
...
- local published Studio docs payloads under `docs-viewer/published/docs/studio/`
- local published Studio docs search under `docs-viewer/published/search/studio/`
