...
```text
source: docs-viewer/source/<scope>/sub-scopes/<sub-scope>/documents/
local published: docs-viewer/published/docs/<scope>/sub-scopes/<sub-scope>/
...
```json
{
  ...
  "title": "Tags",
  "source": {
    "location": { "provider": "repository", "path": "docs-viewer/source/analysis/sub-scopes/tags" },
    "documents_path": "documents",
    "build_media": {},
    "sub_scopes_path": "sub-scopes"
  },
  "published": {
    "documents": { "location": { "provider": "repository", "path": "docs-viewer/published/docs/analysis/sub-scopes/tags" } },
    "search": { "location": { "provider": "repository", "path": "docs-viewer/published/search/analysis/sub-scopes/tags/index.json" } },
    "media": {}
  },
  "public_projection": {
...
```text
docs-viewer/published/docs/<scope>/sub-scopes/<sub-scope>/by-id/<doc_id>.json
docs-viewer/published/docs/<scope>/sub-scopes/<sub-scope>/manifest.json
```
