...
Manage mode replaces the public list source with the compact local inventory so
non-viewable children remain visible and loadable. The report publishes one
...
and non-viewable title prefixes from the compact inventory. It also owns an
