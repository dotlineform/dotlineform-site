...
and non-viewable title prefixes from the compact inventory. Public callers
supply no contribution and import no management module.

The report does not perform writes. The management host projects
