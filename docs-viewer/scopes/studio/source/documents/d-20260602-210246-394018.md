...
Author-facing source-editor behavior is documented separately in [Semantic References Editor](/docs/?scope=studio&doc=d-20260623-180405-631ef4).
Possible authoring enhancements are separated under [Semantic Reference Authoring](/docs/?scope=studio&doc=d-20260527-105208-c1a4d0). None is an active delivery.

This implementation is a pilot. Its parser, picker, renderer, and local report
provide useful evidence, but its file locations, generated schemas, report
shape, and public projection are not the target Semantic Tokens contract. The
proposed replacement structure is documented in
[Semantic Tokens File And Data Structure](/docs/?scope=studio&doc=d-20260725-165142-793cb3).
