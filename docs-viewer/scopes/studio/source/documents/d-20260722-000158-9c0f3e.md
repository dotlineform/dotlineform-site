...
The checkbox-selection foundation is shipped. **Prepare package** is the first registered selection Action and now resolves checked ids as its only target through its compact workflow; its duplicate route is retired and final verification remains in the active delivery.
...
Continue only through explicit checkpoints in the [Prepare Package UI Redesign Delivery](/docs/?scope=studio&doc=d-20260722-133457-e90e21). DSU-P4 final verification and documentation is next and requires explicit approval; no other selection Action is approved.
