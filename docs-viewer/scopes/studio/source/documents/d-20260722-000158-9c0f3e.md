...
The checkbox-selection foundation is shipped. **Prepare package** is the first registered selection Action and now resolves checked ids as its only target through its compact workflow; dedicated-route retirement remains gated in the active delivery.
...
Continue only through explicit checkpoints in the [Prepare Package UI Redesign Delivery](/docs/?scope=studio&doc=d-20260722-133457-e90e21). DSU-P3 dedicated-route retirement is next and requires explicit approval; no other selection Action is approved.
