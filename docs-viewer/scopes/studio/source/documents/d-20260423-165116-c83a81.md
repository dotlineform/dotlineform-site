...
JSON output:
```bash
$HOME/miniconda3/bin/python3 docs-viewer/services/docs_broken_links.py --scope analysis --json
```
...
- `docs-viewer/scopes/analysis/published/documents/index-tree.json`
- `docs-viewer/scopes/analysis/published/documents/by-id/<doc_id>.json`
