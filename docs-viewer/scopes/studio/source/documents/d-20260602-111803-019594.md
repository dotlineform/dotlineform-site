...
All write paths are beneath `/studio/api/tags`. The families are assignment
save and assignment-import preview/apply; focused tag and alias creation;
alias delete; tag and alias mutation preview/apply; alias promotion
preview/apply; and tag demotion preview/apply.
