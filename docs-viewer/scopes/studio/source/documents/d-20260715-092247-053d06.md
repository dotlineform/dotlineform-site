---
doc_id: d-20260715-092247-053d06
...
This is proposed structure. Studio does not currently have a dimension
registry, score model, editor, or visualisation workflow.

## Ownership

- Studio owns catalogue/tag dimension definitions, score records, and review
  workflows.
...
- Docs Viewer or another concrete domain-owned report may consume explicit
  projections; a visualisation does not redefine canonical values.
