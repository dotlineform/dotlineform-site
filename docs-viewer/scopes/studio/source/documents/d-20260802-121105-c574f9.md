...
last_updated: "2026-08-05 20:03:16"
...
The Manage-only Project lookup is generated from the same scanned real-folder rows. SSP-2.5 versions its document-placement meaning with the report. Its accepted subject is an exact Folder key, and its available groups are:
