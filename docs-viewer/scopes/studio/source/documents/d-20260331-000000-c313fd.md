...
| --- | --- | --- |
| Public `/library/`, `/analysis/` | Static shell, public entrypoint, public-safe shared reader, and explicitly promoted public features. | Published static config and generated payloads. No local source or management services. |
