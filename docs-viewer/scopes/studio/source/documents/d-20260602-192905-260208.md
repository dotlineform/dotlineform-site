...
`/analysis/` and `/library/` are public Docs Viewer routes. They may share the site shell and catalogue link helpers, but their document query state, payloads, and reader runtime belong to Docs Viewer.
