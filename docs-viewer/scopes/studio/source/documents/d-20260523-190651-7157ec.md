...
- [ ] For the active **Review package** redesign, retire standalone returned-package summary and hierarchy review/apply; full reviewed-package Import owns returned content, summary, and parent changes together while preserving whole-package behavior.
