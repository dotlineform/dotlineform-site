...
last_updated: "2026-07-24 23:48:11"
...
- [ ] Run `docs-viewer/bin/lint-js [paths...]` or `docs-viewer/bin/lint-python [paths...]`; omitted paths select the proven pilot specimens.
