...
- [ ] Treat lint results as evidence only for the submitted paths. The pilot specimens proved the tooling and conventions; they are not a maintained proxy for wider coverage.
- [ ] Keep suppressions rare, local, and justified.
- [ ] Use of TypeScript, `checkJs`, a `jsconfig.json`, and generated API/reference sites should be assessed before and after major feature changes or refactors.
