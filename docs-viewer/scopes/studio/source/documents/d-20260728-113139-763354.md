...
- a list toolbar for New, collection actions, and selection commands;
...
Status/non-viewable title prefixes, New, collection-local selection, package
preparation, and lazy validated-detail Delete. It also publishes the mounted
collection plus exact document and collection refresh callbacks to the
app-level Import owner. Empty
