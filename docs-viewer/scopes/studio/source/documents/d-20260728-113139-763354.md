...
Status/non-viewable title prefixes, collection-local selection, package
preparation, and lazy validated-detail Delete. Empty list/detail hosts are not
mounted, and the detail host is offered only after by-ID identity validation.
