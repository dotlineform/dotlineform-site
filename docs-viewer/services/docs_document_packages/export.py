...
from studio.shared.python.local_env import runtime_env  # noqa: E402

if __name__ == "__main__":
    os.environ.update(runtime_env(repo_root=REPO_ROOT))

from docs_document_packages.export_common import (  # noqa: E402
...
from docs_document_packages.export_config import (  # noqa: E402
...
from docs_document_packages.export_selection import (  # noqa: E402
    ExportContext,
...
from docs_document_packages.export_transforms import build_document_record  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        print(f"document_package_export: {exc}", file=sys.stderr)
        return 1
