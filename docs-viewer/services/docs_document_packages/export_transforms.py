#!/usr/bin/env python3
"""Field extraction and transform helpers for document-package exports."""
...
from docs_document_packages import rendered_content
from docs_document_packages.export_common import collapse_blank_lines, normalize_text, trim_blank_lines
from docs_document_packages.export_config import SUPPORTED_TRANSFORMS
...
def source_value(context: ExportContext, doc: dict[str, Any], source: str) -> Any:
    ...
    if source in {"doc_id", "title", "parent_id", "summary", "last_updated"}:
