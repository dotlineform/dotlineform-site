#!/usr/bin/env python3
"""Smoke-check Docs Viewer drag/drop move UI through the Docs Viewer service."""
...
from docs_viewer_management_ui import wait_for_doc, wait_for_management_idle, wait_for_management_ready  # noqa: E402
