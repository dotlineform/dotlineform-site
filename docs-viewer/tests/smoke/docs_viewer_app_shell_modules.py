    ...
    result = page.evaluate(
        """async () => {
            ...
            return {
                ...
                missingIds: ids.filter((id) => !document.getElementById(id)),
                manageDocumentControlCount: document.querySelectorAll('#docsViewerManageEditButton, #docsViewerManageSourceButton, #docsViewerStatusPills').length,
