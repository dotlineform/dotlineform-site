...
def test_local_media_route_confines_repo_and_external_scope_assets(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("docs_media_storage.load_docs_media_owner", lambda _repo_root, _scope, **_target: repo_config)
    ...
    monkeypatch.setattr("docs_media_storage.load_docs_media_owner", lambda _repo_root, _scope, **_target: external_config)
