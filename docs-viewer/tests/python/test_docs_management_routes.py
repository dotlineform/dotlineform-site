...
def test_missing_source_files_route_is_management_owned() -> None:
    assert routes.MISSING_SOURCE_FILES_PATH == "/docs/missing-source-files"
    assert routes.MISSING_SOURCE_FILES_PATH in routes.POST_PATHS
