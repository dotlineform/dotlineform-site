...
import docs_working_processing_customisation as processing  # noqa: E402
...
def test_manifest_reports_document_subjects_without_a_folder_inventory(
    ...
    assert payload == {
        "root": {"id": "working_processing", "data": {}},
        "rows": {
...
def test_metadata_uses_the_existing_base_relative_subject_semantics(
    ...
    result = processing.normalize_metadata_update(
        {},
        {"folder_path": str(processing_folder), "work_id": "", "series_id": "", "detail_uid": "", "moment_id": ""},
        repo_root=tmp_path,
