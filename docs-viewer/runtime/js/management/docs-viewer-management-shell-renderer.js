var MANAGEMENT_SHELL_MARKUP = [
  ...
  '  <button class="docsViewer__contextAction" type="button" data-context-action="copy-link">Copy Link</button>',
  ...
  '            <p class="docsViewerImport__intro" id="docsHtmlImportIntro"></p>',
  ...
  '                </span>',
  '              </label>',
  '              <label class="docsViewerImport__field docsViewerImport__field--inline docsViewerImport__field--file">',
  '                <span class="docsViewerImport__fieldLabel" id="docsHtmlImportFileLabel"></span>',
  '                <span class="docsViewerImport__fieldControl">',
  '                  <select class="docsViewerImport__input" id="docsHtmlImportFileSelect"></select>',
  '                </span>',
  '              </label>',
  '            </div>',
  ...
  '            </label>',
  '            <p class="docsViewerImport__meta docsViewerImport__toggleHint" id="docsHtmlImportIncludePromptMetaHint"></p>',
  ...
  '      <label class="docsViewer__field docsViewer__field--checkbox" id="docsViewerSettingsUpdatedField" hidden>',
  '        <input class="docsViewer__checkboxInput" id="docsViewerSettingsUpdatedInput" name="show_updated_date" type="checkbox">',
  '        <span class="docsViewer__fieldLabel" id="docsViewerSettingsUpdatedLabel">show updated date</span>',
  '      </label>',
...
export function findDocsViewerManagementShellRefs(options) {
  ...
  return {
    ...
    settingsUpdatedField: nodeById(documentRef, "docsViewerSettingsUpdatedField"),
