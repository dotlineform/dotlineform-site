...
var MANAGEMENT_SHELL_MARKUP = [
  ...
  '      </label>',
  '      <label class="docsViewer__field" id="docsViewerMetadataGroupField" hidden>',
  '        <span class="docsViewer__fieldLabel">group</span>',
  '        <select class="docsViewer__fieldInput" id="docsViewerMetadataGroupInput" name="group" disabled></select>',
  '      </label>',
  '      <div id="docsViewerMetadataCustomisationHost" hidden></div>',
  '      <label class="docsViewer__field docsViewer__field--checkbox">',
  '        <input class="docsViewer__checkboxInput" id="docsViewerMetadataNonViewableInput" name="non_viewable" type="checkbox" aria-describedby="docsViewerMetadataNonViewableDescription">',
  '        <span class="docsViewer__fieldLabel" id="docsViewerMetadataNonViewableLabel">non-viewable</span>',
  '      </label>',
  '      <p class="docsViewer__modalNote muted small" id="docsViewerMetadataNonViewableDescription">Changes only this document. A non-viewable parent still prevents it from appearing publicly.</p>',
  '      <div class="docsViewer__field docsViewer__field--parent" id="docsViewerMetadataParentField">',
  ...
  '        </div>',
  '      </div>',
  '      <p class="docsViewer__modalNote muted small" id="docsViewerMetadataStatus" hidden></p>',
  ...
  '              <div class="docsViewerImport__source">',
  '                <div class="docsViewerImport__sourceSummary">',
  '                  <span class="docsViewerImport__fieldLabel">Source</span>',
  '                  <output class="docsViewerImport__sourceDirectory" id="docsHtmlImportSourceDirectory"></output>',
  '                </div>',
  '                <div class="docsViewerImport__sourceActions">',
  '                  <button type="button" class="docsViewerImport__button" id="docsHtmlImportChooseSource">Choose folder…</button>',
  '                  <button type="button" class="docsViewerImport__button" id="docsHtmlImportUseStaging">Use import staging</button>',
  '                </div>',
  '              </div>',
  '              <div class="docsViewerImport__field docsViewerImport__field--file">',
  '                <span class="docsViewerImport__fieldControl docsViewerImport__fileControl">',
  '                  <span class="docsViewerImport__candidateTable">',
  '                    <span class="docsViewerImport__candidateHeader" aria-hidden="true">',
  '                      <span>File</span>',
  '                      <span>Destination</span>',
  '                    </span>',
  '                    <span class="docsViewerImport__candidateList" id="docsHtmlImportCandidateList" role="listbox" tabindex="0" aria-label="Staged sources"></span>',
  '                  </span>',
  '                </span>',
  '              </div>',
  '              <p class="docsViewerImport__candidateNote muted small" id="docsHtmlImportCandidateNote" aria-live="polite"></p>',
  '            </div>',
  ...
  '              <button type="button" class="docsViewerImport__button docsViewerImport__button--defaultWidth" id="docsHtmlImportReview">Open in Docs Review</button>',
  ...
  '  </div>',
  '</div>',
  '<div class="docsViewer__modal" id="docsViewerImportFolderModal" hidden>',
  '  <div class="docsViewer__modalBackdrop" data-import-folder-close="true"></div>',
  '  <div class="docsViewer__modalCard docsViewer__modalCard--document docsViewer__modalCard--importFolder" role="dialog" aria-modal="true" aria-labelledby="docsViewerImportFolderHeading">',
  '    <div class="docsViewer__modalHeader">',
  '      <div class="docsViewer__modalHeaderCopy">',
  '        <h2 class="docsViewer__modalTitle" id="docsViewerImportFolderHeading">Choose import folder</h2>',
  '      </div>',
  '    </div>',
  '    <div class="docsViewer__modalForm docsViewer__modalForm--dynamic">',
  '      <div class="docsViewer__modalBody docsViewerImport__folderPicker" id="docsViewerImportFolderPicker"></div>',
  '      <div class="docsViewer__modalActions">',
  '        <button type="button" class="docsViewerImport__button docsViewerImport__button--defaultWidth" id="docsViewerImportFolderCancel">Cancel</button>',
  '        <button type="button" class="docsViewerImport__button docsViewerImport__button--defaultWidth" id="docsViewerImportFolderConfirm">Choose</button>',
  '      </div>',
  '    </div>',
  '  </div>',
  '</div>',
  '<div class="docsViewer__modal" id="docsViewerImportCollectionModal" hidden>',
  '  <div class="docsViewer__modalBackdrop" data-import-collection-close="true"></div>',
  '  <div class="docsViewer__modalCard docsViewer__modalCard--document docsViewer__modalCard--importCollection" role="dialog" aria-modal="true" aria-labelledby="docsViewerImportCollectionHeading">',
  '    <div class="docsViewer__modalHeader">',
  '      <div class="docsViewer__modalHeaderCopy">',
  '        <h2 class="docsViewer__modalTitle" id="docsViewerImportCollectionHeading">Confirm package import</h2>',
  '      </div>',
  '    </div>',
  '    <div class="docsViewer__modalForm docsViewer__modalForm--dynamic">',
  '      <div class="docsViewer__modalBody">',
  '        <div class="docsViewerImport__collection" id="docsImportCollectionView" hidden></div>',
  '      </div>',
  '      <p class="docsViewerImport__status" id="docsImportCollectionStatus" role="status" aria-live="polite"></p>',
  '      <div class="docsViewer__modalActions">',
  '        <button type="button" class="docsViewerImport__button docsViewerImport__button--defaultWidth" id="docsImportCollectionCancel" data-collection-command="cancel" hidden>Cancel</button>',
  '        <button type="button" class="docsViewerImport__button docsViewerImport__button--defaultWidth" id="docsImportCollectionConfirm" data-collection-command="confirm" hidden>Confirm import</button>',
  '        <button type="button" class="docsViewerImport__button docsViewerImport__button--defaultWidth" id="docsImportCollectionRetry" data-collection-command="retry-refresh" hidden>Retry refresh</button>',
  '        <button type="button" class="docsViewerImport__button docsViewerImport__button--defaultWidth" id="docsImportCollectionClose" data-collection-command="close" hidden>Close</button>',
  '      </div>',
  '    </div>',
  '  </div>',
  '</div>',
...
export function findDocsViewerManagementShellRefs(options) {
  ...
  return {
    ...
    metadataGroupField: nodeById(documentRef, "docsViewerMetadataGroupField"),
    metadataGroupInput: nodeById(documentRef, "docsViewerMetadataGroupInput"),
    metadataCustomisationHost: nodeById(documentRef, "docsViewerMetadataCustomisationHost"),
    metadataNonViewableInput: nodeById(documentRef, "docsViewerMetadataNonViewableInput"),
    metadataParentField: nodeById(documentRef, "docsViewerMetadataParentField"),
    ...
    metadataStatus: nodeById(documentRef, "docsViewerMetadataStatus"),
    ...
    importFolderModal: nodeById(documentRef, "docsViewerImportFolderModal"),
    importFolderPicker: nodeById(documentRef, "docsViewerImportFolderPicker"),
    importFolderCancelButton: nodeById(documentRef, "docsViewerImportFolderCancel"),
    importFolderConfirmButton: nodeById(documentRef, "docsViewerImportFolderConfirm"),
    importCollectionModal: nodeById(documentRef, "docsViewerImportCollectionModal"),
    importCollectionView: nodeById(documentRef, "docsImportCollectionView"),
    importCollectionStatus: nodeById(documentRef, "docsImportCollectionStatus"),
    importCollectionCancelButton: nodeById(documentRef, "docsImportCollectionCancel"),
    importCollectionConfirmButton: nodeById(documentRef, "docsImportCollectionConfirm"),
    importCollectionRetryButton: nodeById(documentRef, "docsImportCollectionRetry"),
