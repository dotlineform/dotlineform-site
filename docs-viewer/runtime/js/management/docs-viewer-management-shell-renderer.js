...
var MANAGEMENT_SHELL_MARKUP = [
  ...
  '                </span>',
  '              </div>',
  '              <dl class="docsViewerImport__candidateDetails" id="docsHtmlImportCandidateDetails">',
  '                <div>',
  '                  <dt>Source kind</dt>',
  '                  <dd id="docsHtmlImportCandidateKind"></dd>',
  '                </div>',
  '                <div>',
  '                  <dt>Effective destination</dt>',
  '                  <dd id="docsHtmlImportCandidateDestination"></dd>',
  '                </div>',
  '              </dl>',
