export const DOCS_VIEWER_ACTION_IDS = Object.freeze({
  ...
  SOURCE_ADD_CATALOGUE_TOKEN: "source-add-catalogue-token",
  SOURCE_ADD_CONCEPT_TOKEN: "source-add-concept-token",
  SOURCE_ADD_FILE: "source-add-file",
  SOURCE_ADD_IMAGE: "source-add-image",
  SOURCE_INSERT_SUBJECT_LINK: "source-insert-subject-link",
  MOVE: "move",
  NEW: "new",
  NEW_CHILD: "new-child",
  NEW_SCOPE: "new-scope",
...
export const DOCS_VIEWER_ACTION_DEFINITIONS = Object.freeze({
  ...
  [IDS.SOURCE_ADD_CATALOGUE_TOKEN]: actionDefinition(IDS.SOURCE_ADD_CATALOGUE_TOKEN, TARGETS.ACTIVE_DOCUMENT),
  [IDS.SOURCE_ADD_CONCEPT_TOKEN]: actionDefinition(IDS.SOURCE_ADD_CONCEPT_TOKEN, TARGETS.ACTIVE_DOCUMENT),
  ...
  [IDS.SOURCE_INSERT_SUBJECT_LINK]: actionDefinition(IDS.SOURCE_INSERT_SUBJECT_LINK, TARGETS.ACTIVE_DOCUMENT),
