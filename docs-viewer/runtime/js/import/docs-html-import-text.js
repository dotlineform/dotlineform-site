var DOCS_HTML_IMPORT_TEXT = {
  ...
  collectionConfirmationMessage: "This complete package is ready to import. Content, summaries, and hierarchy changes will be applied together.",
  ...
  collectionRefreshRetryButton: "Retry report refresh",
  ...
  loadPackagesFailed: "Failed to load returned packages. Ordinary staged documents remain available.",
  ...
  packageDocumentCount: "{count} documents",
