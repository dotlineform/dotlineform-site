...
The documents mapping uses a data-domain-first workflow root:

```text
var/analytics/data-sharing/documents/
```

Under that root, document package workflows currently use:
