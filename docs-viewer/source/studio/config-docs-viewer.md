...
`docs-viewer/config/defaults/docs-viewer-config.json` and `docs-viewer/config/defaults/docs-viewer-public-config.json` are generated by `./scripts/build_docs.rb --write`.
