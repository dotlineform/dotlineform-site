...
[Configuration Map](/docs/?scope=studio&doc=config-files-inventory) finds the main registries.
...
[Docs Viewer Overview](/docs/?scope=studio&doc=docs-viewer-overview) and [Runtime](/docs/?scope=studio&doc=docs-viewer-runtime-boundary) own the architecture map.

### Docs Import, Docs Review, And Data Sharing

- [ ] Start from [Docs Import Architecture](/docs/?scope=studio&doc=docs-viewer-import-source-registry-spec), [Docs Review](/docs/?scope=studio&doc=docs-viewer-review), and [Data Sharing Overview](/docs/?scope=studio&doc=data-sharing-overview); do not copy their module inventories here.
...
[Source Tree Ownership](/docs/?scope=studio&doc=source-tree-ownership) owns the directory map.
...
[Testing](/docs/?scope=studio&doc=testing) owns selection policy.
