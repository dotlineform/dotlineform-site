...
- `studio/services/catalogue/catalogue_routes.py` is the stable catalogue route constant inventory for activity profiles and request-contract documentation.

## Child References

- [Endpoint Reference](/docs/?scope=studio&doc=scripts-catalogue-write-server-endpoints) lists read, save, create, delete, publication, moment prose import, workbook import, series, and build endpoint request contracts.
