...
- canonical work prose under `_docs_catalogue/works/`
- canonical series prose under `_docs_catalogue/series/`
- canonical moment prose under `_docs_catalogue/moments/`
