...
- [Docs Viewer Roadmap](/docs/?scope=studio&doc=d-20260714-234030-1e0af6) — the completed prerequisite and unsequenced future outcomes.

## Current State

The action-target prerequisite is complete. `docs-viewer-action-definitions.js` now gives current controls one code-owned scope, active-document, or selection target policy without adding multiple-selection state. [Runtime Module Ownership](/docs/?scope=studio&doc=d-20260605-125108-1d1ef3) is the durable owner for that shipped boundary.
