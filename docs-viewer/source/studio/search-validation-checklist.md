...
- [ ] Run `./studio/services/catalogue/search/build_search.py --scope catalogue`
- [ ] Confirm the dry run completes without error, including Catalogue build-config validation
- [ ] Run `./studio/services/catalogue/search/build_search.py --scope catalogue --write`
...
- [ ] If the change touched catalogue targeted search, run `./studio/services/catalogue/search/build_search.py --scope catalogue --only-records moment:4-stories`
