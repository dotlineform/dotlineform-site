...
- Supported trusted Data Sharing JSON/JSONL is classified as `data_sharing_documents` from trusted export metadata. Unregistered JSON/JSONL is not a Docs Import source.
