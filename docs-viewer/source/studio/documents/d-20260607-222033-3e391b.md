...
- validates the existing external source and published roots against the lifecycle-owned path contract
...
- moves the external source root, the published-documents root containing local media, and the published-search root to the new scope folder name
