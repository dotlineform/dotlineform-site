...
| --- | --- | --- | --- | --- |
| Studio docs | `docs-viewer/source/studio/*.md` | none by default | `docs-viewer/generated/docs/studio/`, `docs-viewer/generated/search/studio/index.json`, `<DOCS_VIEWER_BASE_URL>/docs/` manage payload reads | [Studio Overview](/docs/?scope=studio&doc=d-20260715-084611-ae9636), [Docs Viewer Builder](/docs/?scope=studio&doc=d-20260423-000000-c9f3ea) |
...
| Analysis docs | `docs-viewer/source/analysis/*.md` | `site/assets/data/docs/scopes/analysis/`, `site/assets/data/search/analysis/index.json`, `/analysis/` | local manage-mode access to the same generated payloads | [Public Scopes](/docs/?scope=studio&doc=d-20260331-000000-f992b9) |
