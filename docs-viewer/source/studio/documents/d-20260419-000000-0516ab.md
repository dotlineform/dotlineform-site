...
### `docs-viewer/source/studio/documents/*.md`
...
### `docs-viewer/published/docs/studio/index-tree.json`
...
### `docs-viewer/published/docs/studio/by-id/<doc_id>.json`
...
### `docs-viewer/published/search/studio/index.json`
...
- docs with `viewable: false` can have published payloads for manage mode, but are filtered out of public/default docs search
