...
Within this repository, use [Scope Lifecycle](/docs/?scope=studio&doc=d-20260515-000000-f43740) to create another configured public, committed-local, or external-local scope. That is a supported in-repo capability, not evidence that the whole application is portable.
...
- public/manage delivery boundary: [Runtime Architecture](/docs/?scope=studio&doc=d-20260331-000000-c313fd)
- configuration owners: [Configuration And Extension Points](/docs/?scope=studio&doc=d-20260512-142027-54b354)
- source and generated layout: [Source Organisation](/docs/?scope=studio&doc=d-20260423-000000-8fd731)
- public snapshot boundary: [Public Scopes](/docs/?scope=studio&doc=d-20260331-000000-f992b9)
- Python requirements: [Dependencies](/docs/?scope=studio&doc=d-20260514-180120-b23811)
