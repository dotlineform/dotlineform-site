...
The builder derives working and public `recent.json` projections independently from complete eligible source sets. Each projection declares its route-configured `added` or `edited` basis; public eligibility is applied before sorting and limiting.
