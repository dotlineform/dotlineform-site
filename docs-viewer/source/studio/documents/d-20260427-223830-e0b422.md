...
`/studio/project-state/` calls the same builder through the Local Studio API and can open the resulting Markdown file through a separately confined local capability. The [Project State](/docs/?scope=studio&doc=d-20260427-223830-ad1ab0) page documents that operator workflow.
