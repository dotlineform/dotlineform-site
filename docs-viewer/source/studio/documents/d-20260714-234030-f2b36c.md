...
- ordinary scope-owned media stays beneath that source root
...
- Repo-backed and external-local document attachments remain ordinary scope-owned media under `<scope source root>/media/`.
