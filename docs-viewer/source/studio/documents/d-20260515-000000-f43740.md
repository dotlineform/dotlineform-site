...
| External-local source container | Created, renamed, and delete-owned by its recorded derived path. Its configured source and published media stay inside the container and follow the same lifecycle. |
| External-local published docs/search roots | Created, renamed, and delete-owned by their recorded derived paths. |
