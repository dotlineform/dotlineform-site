...
Implementation is tracked in [Docs Viewer Public Index Slimming Tasks](/docs/?scope=studio&doc=site-request-docs-viewer-public-index-slimming-tasks).

The implementation tracker owns task state and links to the focused batch delivery docs:

- [Batch 1: Discovery and Contract Lock](/docs/?scope=studio&doc=site-request-docs-viewer-public-index-slimming-batch-1)
- [Batch 2: Builder Outputs](/docs/?scope=studio&doc=site-request-docs-viewer-public-index-slimming-batch-2)
- [Batch 3: Runtime Loading and Boundary Check](/docs/?scope=studio&doc=site-request-docs-viewer-public-index-slimming-batch-3)
- [Batch 4: Info Panel Hydration and Rendering](/docs/?scope=studio&doc=site-request-docs-viewer-public-index-slimming-batch-4)
