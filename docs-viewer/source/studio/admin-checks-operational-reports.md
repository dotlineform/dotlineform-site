...
It is intentionally separate from [Admin Checks Responsibility Reports](/docs/?scope=studio&doc=admin-checks-responsibility-reports), which is scoped to responsibility and ownership evidence.
...
Responsibility report deliveries belong under [Admin Checks Responsibility Reports](/docs/?scope=studio&doc=admin-checks-responsibility-reports) when their primary question is about:
