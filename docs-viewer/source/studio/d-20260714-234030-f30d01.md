...
Current runtime still supplies a one-document selection context, so this foundation preserves existing behavior. [Runtime Module Ownership](/docs/?scope=studio&doc=d-20260605-125108-1d1ef3) is the durable current-state authority.
...
The [Docs Viewer Roadmap](/docs/?scope=studio&doc=d-20260714-234030-1e0af6) owns delivery order. This proposed architecture is not an implementation checklist.
