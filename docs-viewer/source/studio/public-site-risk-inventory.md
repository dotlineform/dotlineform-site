...
| Media derivation and remote publishing | Performance / cost | [Studio Python And Ruby Script Inventory](/docs/?scope=studio&doc=studio-python-ruby-script-inventory) classifies media derivation as medium maintenance and high performance risk, and flags `studio/services/catalogue/catalogue_build_media.py` as a concrete performance candidate because media work is file-system and subprocess heavy. | Add batch timing and count evidence before changing media derivation or publishing behavior. |
