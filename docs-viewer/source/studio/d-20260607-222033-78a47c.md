...
last_updated: "2026-07-16 21:28:13"
...
The preview is write-free. It validates two different configured scopes, requires a readable source root and a target root that can accept managed canonical writes, expands the complete source subtree in deterministic tree order, captures one copy timestamp, and allocates a new immutable identity and matching target filename for every copied document.
