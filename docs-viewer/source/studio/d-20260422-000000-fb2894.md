...
Use [Catalogue Build And Lookup Refresh](/docs/?scope=studio&doc=d-20260519-202931-0c703e) for the two derived-output planners. Code and request-contract tests are the authority for exact payload fields.
