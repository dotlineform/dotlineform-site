...
- Start with SDSA-014: update focused tests and smokes for the new service boundary, adapter resolution, selectable-record contract, document prepare/review/apply flows, tags prepare/review/apply flows, artifact roots, and unavailable-service states.
