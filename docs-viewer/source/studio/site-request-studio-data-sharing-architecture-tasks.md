...
- Start with SDSA-011: standardize active package, staging, and review roots under `var/studio/data-sharing/<domain>/...`; remove remaining `var/studio/export-import/...` assumptions without adding disposable-package compatibility reads.
