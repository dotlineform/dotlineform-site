...
- `docs-viewer/runtime/js/docs-viewer-report-service.js` owns browser-side local report endpoint paths, request options, local-server missing-base errors, and response-envelope differences for source-config, generated docs-log, and broken-links audit reports.
