...
| Browser config URL | Public default: `/studio/docs-viewer/config/runtime/docs-viewer-public-config.json`; manage default: `/studio/docs-viewer/config/runtime/docs-viewer-config.json` | `_config.yml`, includes, Local Studio shell, browser fallback code |
...
- `studio_docs_api.py` imports `studio/docs-viewer/services/docs_management_service.py` and adapts Local Studio API requests to Docs Viewer service functions.
...
- `bin/local-studio` starts the docs watcher and validates Docs Viewer scope ids from `studio/docs-viewer/config/scopes/docs_scopes.json`.
