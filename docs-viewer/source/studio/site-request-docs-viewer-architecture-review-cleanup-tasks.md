...
- Continue with document/sidebar/report, info-panel, and config/scope state narrowing (`IT-12`, `IT-13`, `IT-14`) now that the route/search/bookmark state and command boundary slices (`IT-1`, `IT-2`, `IT-3`) are complete.
