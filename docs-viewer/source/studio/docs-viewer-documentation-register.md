...
| Source reads and writes | [Source Editor Endpoints](/docs/?scope=studio&doc=scripts-docs-management-endpoints-source-editor), [Docs Review Endpoints](/docs/?scope=studio&doc=scripts-docs-management-endpoints-review) | [Source Editor Scripts](/docs/?scope=studio&doc=scripts-docs-management-scripts-source-editor), [Docs Review](/docs/?scope=studio&doc=docs-viewer-review) | provider and endpoint contracts | Manage and review source methods are independently authorized provider capabilities; review writes are package-rooted and body-only. |
...
| Reviewed-package admission | [Docs Import Source Registry](/docs/?scope=studio&doc=docs-viewer-import-source-registry-spec) | [Create And Import Endpoints](/docs/?scope=studio&doc=scripts-docs-management-endpoints-create-import), [Docs Import Reviewed Package](/docs/?scope=studio&doc=site-request-docs-import-reviewed-package) | proposed source-provider and create-only batch import | Docs Viewer Import owns new-document creation; Data Sharing ends at the validated package handoff. |
...
| `site-request-docs-import-reviewed-package` | change request | proposed | Create-only reviewed-package import and reusable source-provider seam | Keep active under Docs Viewer Import after the validated-package producer. | present |
