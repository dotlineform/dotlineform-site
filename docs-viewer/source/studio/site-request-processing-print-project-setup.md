---
doc_id: site-request-processing-print-project-setup
title: Processing Print Project Setup
added_date: 2026-07-13
last_updated: 2026-07-13
ui_status: draft
parent_id: change-requests
---
# Processing Print Project Setup

Status: note for future work

## Summary

Bring the existing unfinished Processing projects into this repository, recover how they work, and establish a maintainable structure for continuing them.
...
This note owns the initial setup proposal.

When work begins, review whether implementation also needs to update:

- [Source Documentation and Linting](/docs/?scope=studio&doc=site-request-source-documentation-and-linting) with Processing-specific Javadoc or Java checks
- `source-tree-ownership.md` if a new top-level `processing/` source area is adopted
- repository setup or dependency documentation once the required Processing version and libraries are known
- a new Docs Viewer scope containing Processing project notes and source reference

Do not add stable setup instructions until an original project has been recovered successfully on the current machine.
