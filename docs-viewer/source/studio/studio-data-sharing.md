...
Those helpers are split by responsibility under `docs-viewer/services/`: `docs_data_sharing_package.py`, `docs_data_sharing_review.py`, `docs_data_sharing_apply.py`, and `docs_data_sharing_write.py`.
