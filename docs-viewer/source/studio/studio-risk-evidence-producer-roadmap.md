...
| Static searches | implemented | [Studio Risk Evidence Pack](/docs/?scope=studio&doc=studio-risk-evidence-pack) | Uses configured regex patterns over selected app roots. |
