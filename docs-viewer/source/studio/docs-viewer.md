...
- [Toolbar Model](/docs/?scope=studio&doc=docs-viewer-toolbar-model) records the target top-bar, viewer-toolbar, manage-toolbar, document-toolbar, and context-panel-toolbar model.
