...
- compatibility route/document runtime orchestration in `docs-viewer/runtime/js/docs-viewer-app-runtime.js` until the next route/document workflow extraction
