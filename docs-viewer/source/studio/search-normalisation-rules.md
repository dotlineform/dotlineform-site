...
- [Search Field Registry](/docs/?scope=studio&doc=search-field-registry-table) defines which fields participate in search
- [Search Ranking Model](/docs/?scope=studio&doc=search-ranking-model) defines how normalized matches are prioritized
- [Search Build Pipeline](/docs/?scope=studio&doc=search-build-pipeline-architecture) defines where index-time normalization occurs
