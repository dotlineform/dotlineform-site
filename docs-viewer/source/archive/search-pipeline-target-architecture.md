...
- explicit domain-owned build scripts for Catalogue search and Docs Viewer search
...
- docs canonical outputs are still built from `docs-viewer/build/build_docs.rb`
