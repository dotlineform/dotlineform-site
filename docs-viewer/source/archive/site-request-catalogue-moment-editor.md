...
- prose in `_docs_catalogue/moments/<moment_id>.md`
...
6. Page shows canonical prose source readiness for `_docs_catalogue/moments/<moment_id>.md`.
...
4. Server writes `_docs_catalogue/moments/<moment_id>.md`.
...
- compare against `_docs_catalogue/moments/<moment_id>.md`
