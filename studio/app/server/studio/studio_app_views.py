...
<head>
  ...
  <link rel="stylesheet" href="/shared/frontend/css/file-picker.css?v={escaped_version}">
  <link rel="stylesheet" href="/shared/frontend/css/record-list.css?v={escaped_version}">
