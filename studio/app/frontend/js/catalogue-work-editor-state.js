...
export function collectWorkEditorElements() {
  return collectRequiredElements({
    ...
    detailBrowserHeadingNode: "catalogueWorkDetailBrowserHeading",
    detailBrowserMetaNode: "catalogueWorkDetailBrowserMeta",
    detailBrowserSectionsHeadingNode: "catalogueWorkDetailBrowserSectionsHeading",
    detailBrowserSectionsNode: "catalogueWorkDetailBrowserSections",
    detailBrowserImagesHeadingNode: "catalogueWorkDetailBrowserImagesHeading",
    detailBrowserImagesMetaNode: "catalogueWorkDetailBrowserImagesMeta",
...
export function createWorkEditorState(elements, options = {}) {
  const {
    ...
    detailBrowserHeadingNode,
    detailBrowserMetaNode,
    detailBrowserSectionsHeadingNode,
    detailBrowserSectionsNode,
    detailBrowserImagesHeadingNode,
    detailBrowserImagesMetaNode,
