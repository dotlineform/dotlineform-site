...
export function createWorkEditorState(elements, options = {}) {
  ...
  return {
    ...
    newDetailLinkNode,
    filesActionsNode: elements.filesActionsNode,
    filesMetaNode,
    filesResultsNode,
    filesPanelNode: filesResultsNode.closest("section"),
    newFileLinkNode,
    linksActionsNode: elements.linksActionsNode,
    linksMetaNode,
    linksResultsNode,
