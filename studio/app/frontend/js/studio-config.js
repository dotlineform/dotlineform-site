const DEFAULT_STUDIO_CONFIG = {
  ...
  "paths": {
    "routes": {
      ...
      "docs_page": "http://127.0.0.1:8776/docs/",
    ...
    "data": {
      ...
      "ui_text": {
        ...
        "tag_registry": "/studio/app/frontend/config/ui-text/tag-registry.json",
        ...
        "tag_groups": "/studio/app/frontend/config/ui-text/tag-groups.json"
      }
    }
  },
  "analysis": {
