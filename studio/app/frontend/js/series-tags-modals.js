...
import { seriesTagsUi } from "./tag-ui.js";
  ...
  const bodyHtml = `
    <div class="analyticsToolbar seriesTagsSession">
      ...
      <div class="analyticsToolbar__row seriesTagsSession__row" data-role="${UI.role.sessionActions}">
        <button type="button" class="studioUi__button studioUi__button--defaultWidth ${UI_CLASS.sessionAction}" data-session-action="copy"${hasStaged ? "" : " disabled"}>
          ${escapeHtml(seriesTagsText(state.config, "session_copy_button", "Copy JSON"))}
        </button>
        <button type="button" class="studioUi__button studioUi__button--defaultWidth ${UI_CLASS.sessionAction}" data-session-action="download"${hasStaged ? "" : " disabled"}>
          ${escapeHtml(seriesTagsText(state.config, "session_download_button", "Download JSON"))}
        </button>
        <button type="button" class="studioUi__button studioUi__button--defaultWidth ${UI_CLASS.sessionAction}" data-session-action="clear"${hasStaged ? "" : " disabled"}>
  ...
  const bodyHtml = `
    <div class="analyticsToolbar analyticsToolbar--modalImport seriesTagsSession">
      <div class="analyticsToolbar__row seriesTagsSession__row" data-role="${UI.role.sessionImport}">
        ...
        <button type="button" class="studioUi__button studioUi__button--defaultWidth ${UI_CLASS.sessionAction}" data-import-action="choose-file">
          ${escapeHtml(seriesTagsText(state.config, "session_import_choose_button", "Choose file"))}
        </button>
        <button type="button" class="studioUi__button studioUi__button--defaultWidth ${UI_CLASS.sessionAction}" data-import-action="preview-import"${hasFile ? "" : " disabled"}>
...
function renderModalStatus(state, role) {
  ...
  return `<p class="analyticsForm__status studioModal__status" data-role="${escapeHtml(role)}"${stateAttr}${hiddenAttr}>${escapeHtml(message)}</p>`;
}
