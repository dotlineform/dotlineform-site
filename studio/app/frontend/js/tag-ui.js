...
export const tagRegistryUi = createUiContract({
  role: {
    ...
    editDocumentList: "edit-document-list",
    addEditDocument: "add-edit-document",
    editDocumentPicker: "edit-document-picker",
    editDocumentSearch: "edit-document-search",
    editDocumentPopup: "edit-document-popup",
  ...
  className: {
    ...
    documentsCol: "tagRegistry__documentsCol",
    documentLinks: "tagRegistry__documentLinks",
    documentLink: "tagRegistry__documentLink",
