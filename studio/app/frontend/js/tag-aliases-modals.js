...
import { tagAliasesUi } from "./tag-ui.js";
...
function renderPromotionModal(state) {
  return renderStudioModalFrame({
    ...
    bodyHtml: `
      ...
      <div class="studioUi__key ${UI_CLASS.formKey}" data-role="${UI.role.promotionGroupKey}"></div>
    ...
    bodyHtml: `
      ...
      <div class="${UI_CLASS.formFields}">
        <label class="${UI_CLASS.formField} ${UI_CLASS.formSearchWrap}">
          <input type="text" class="studioUi__input" data-role="${UI.role.demoteTagSearch}" autocomplete="off" placeholder="${escapeHtml(aliasesText(state.config, "demotion_search_placeholder", "search tags"))}">
    ...
    bodyHtml: `
      <div class="${UI_CLASS.formFields}">
        <label class="${UI_CLASS.formField}">
          ...
          <input type="text" class="studioUi__input" data-role="${UI.role.editAliasName}" autocomplete="off">
        </label>
        ...
        <label class="${UI_CLASS.formField}">
          ...
          <textarea class="studioUi__input ${UI_CLASS.editDescription}" data-role="${UI.role.editAliasDescription}" rows="2"></textarea>
        </label>
        <div class="studioUi__key ${UI_CLASS.formKey}" data-role="${UI.role.editGroupKey}"></div>
        <label class="${UI_CLASS.formField} ${UI_CLASS.formSearchWrap}">
          <input type="text" class="studioUi__input" data-role="${UI.role.editTagSearch}" autocomplete="off" placeholder="${escapeHtml(aliasesText(state.config, "edit_search_placeholder", "search tags"))}">
