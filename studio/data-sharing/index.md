...
>
  <section class="catalogueDashboardRoutes" aria-label="Data Sharing links">
    ...
    <section class="catalogueDashboardColumn">
      <h3>Planned domains</h3>
      <ul class="catalogueDashboardPills">
        <li><a href="{{ '/studio/data-sharing/prepare/?scope=catalogue' | relative_url }}">catalogue packages</a></li>
        <li><a href="{{ '/studio/data-sharing/prepare/?scope=analytics' | relative_url }}">analytics packages</a></li>
      </ul>
    </section>
  </section>
</div>
