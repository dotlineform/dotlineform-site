...
ROUTE_PATH = "/studio/catalogue-status/?mode=manage"
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if legacy_catalogue_service_requests:
            raise AssertionError(f"Catalogue Drafts still called legacy catalogue service: {legacy_catalogue_service_requests}")
        if console_errors:
