#!/usr/bin/env python3
"""Smoke local Studio analytics tag assignment APIs against a fixture repo."""
...
def run() -> None:
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        try:
            ...
            response = post_json(
                f"http://127.0.0.1:{port}/studio/api/analytics/save-tags",
                {
                    "series_id": "series-a",
            ...
            preview = post_json(
                f"http://127.0.0.1:{port}/studio/api/analytics/import-tag-assignments-preview",
                {
            ...
            apply = post_json(
                f"http://127.0.0.1:{port}/studio/api/analytics/import-tag-assignments",
                {
                    "import_assignments": import_assignments,
                    "import_filename": "import.json",
                    "resolutions": {},
    ...
    print("local Studio analytics tag assignment APIs OK")
