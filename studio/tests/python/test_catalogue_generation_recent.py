    ...
    assert entries == [
        {
            ...
            "recorded_at_utc": "2026-05-09T12:00:00Z",
            "session_order": 1,
            "href": "/works/?from=recent&work=00004",
        }
    ]
    ...
    assert entries == [
        {
            ...
            "recorded_at_utc": "2026-05-09T12:00:00Z",
            "session_order": 1,
            "href": "/works/?from=recent&work=00002",
        }
    ]
    ...
    assert entries == [
        {
            ...
            "recorded_at_utc": "2026-05-09T12:00:00Z",
            "session_order": 1,
            "href": "/series/?series=009&from=recent",
        }
    ]
...
def test_payload_cap_and_ordering_are_deterministic() -> None:
    entries = normalized_entries([
        {"kind": "work", "target_id": "00001", "title": "B", "published_date": "2026-05-02", "recorded_at_utc": "2026-05-02T09:00:00Z", "session_order": 2, "href": "/works/?from=recent&work=00001"},
        {"kind": "series", "target_id": "009", "title": "A", "published_date": "2026-05-02", "recorded_at_utc": "2026-05-02T09:00:00Z", "session_order": 1, "href": "/series/?series=009&from=recent"},
        {"kind": "work", "target_id": "00002", "title": "C", "published_date": "2026-05-03", "recorded_at_utc": "2026-05-03T09:00:00Z", "session_order": 1, "href": "/works/?from=recent&work=00002"},
    ])
    ...
    assert payload["header"]["schema"] == "recent_index_v2"
