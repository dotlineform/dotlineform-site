    ...
    cases = [
        ...
        (
            ...
            plan_for(registry, record_family="work", fields=["title"], context=work_sort_context()),
            {
                ...
                "generate_only": ["work-json", "series-json", "recent-index-json"],
                "rebuild_search": True,
                "generate_local_media": False,
                "build_required": True,
            },
        ...
        (
            ...
            plan_for(registry, record_family="work", fields=["series_ids"]),
            {
                ...
                "generate_only": ["work-json", "series-json", "series-index-json", "recent-index-json"],
                "rebuild_search": True,
                "generate_local_media": False,
                "build_required": True,
            },
        ...
        (
            ...
            plan_for(registry, record_family="series", fields=["status"]),
            {
                ...
                "generate_only": ["series-json", "series-index-json", "recent-index-json"],
                "rebuild_search": True,
                "generate_local_media": False,
                "build_required": True,
            },
