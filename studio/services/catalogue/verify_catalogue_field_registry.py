...
def main() -> None:
    ...
    cases = [
        ...
        (
            "work display metadata with exact Series members",
            plan_for(registry, record_family="work", fields=["title"], context=work_sort_context()),
            {
                ...
                "generate_only": ["work-json", "series-pages", "recent-index-json"],
                "rebuild_search": True,
                "generate_local_media": False,
                "build_required": True,
            },
        ...
        (
            ...
            plan_for(registry, record_family="work", fields=["series_ids"]),
            {
                ...
                "generate_only": ["work-json", "series-pages", "series-index-json", "recent-index-json"],
                "rebuild_search": True,
                "generate_local_media": False,
                "build_required": True,
            },
    ...
    assert_plan(
        ...
        generate_only=["work-pages", "work-json", "series-pages", "series-index-json", "recent-index-json"],
        rebuild_search=True,
        generate_local_media=True,
        fallback=True,
