...
def handle_catalogue_post(
    ...
    *,
    ...
    if api_path in {"/build-preview", "/build-apply", "/media-publish-preview", "/media-publish-apply"}:
        return HTTPStatus.SERVICE_UNAVAILABLE, {"ok": False, "error": "Catalogue output and media operations are paused until Stage 5."}
