...
<div class="studioDashboard">
  ...
  <section class="studioDashboard__section">
    ...
    <div class="studioCardGrid">
      <a class="tagStudio__panel tagStudio__panelLink" href="{{ '/search/' | relative_url }}">
        <h4>Public search</h4>
        <p>Open the user-facing search runtime.</p>
      </a>
      <a class="tagStudio__panel tagStudio__panelLink" href="{{ '/docs/?scope=studio&doc=new-pipeline-refine-search' | relative_url }}">
        <h4>Search plan</h4>
        <p>Parallel planning stub for Search administration and validation workflows.</p>
      </a>
      <a class="tagStudio__panel tagStudio__panelLink" href="{{ '/docs/?scope=studio&doc=search-change-log' | relative_url }}">
