...
- Treat current `assets/docs-viewer/` as Docs Viewer-owned runtime/static input for the frontend/static move slice; separate it from generated public docs/search payloads.
