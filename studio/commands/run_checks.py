    ...
    "quick": (
        ...
        CheckCommand(
            ...
            (
                ...
                "studio/docs-viewer/services/docs_management_broken_links_service.py",
                "studio/docs-viewer/services/docs_management_capabilities_service.py",
                "studio/docs-viewer/services/docs_management_context.py",
                "studio/docs-viewer/services/docs_management_data_sharing_service.py",
                "studio/docs-viewer/services/docs_management_import_service.py",
                "studio/docs-viewer/services/docs_management_mutation_service.py",
                "studio/docs-viewer/services/docs_management_read_service.py",
                "studio/docs-viewer/services/docs_management_source_service.py",
                "studio/docs-viewer/services/docs_management_service.py",
                "studio/docs-viewer/services/docs_management_mutations.py",
                "studio/docs-viewer/services/docs_scope_manifest.py",
                ...
                "studio/tests/smoke/docs_viewer_management_modal.py",
                ...
                "studio/tests/python/test_docs_activity.py",
                ...
                "studio/tests/python/test_tag_registry_mutations.py",
                "studio/tests/python/test_tag_source_model.py",
                "studio/tests/python/test_tag_write_transactions.py",
                "studio/tests/python/test_docs_live_rebuild_watcher.py",
                "studio/tests/python/test_docs_management_mutations.py",
                ...
                "studio/tests/python/test_studio_backup_retention.py",
            ),
        ...
        CheckCommand(
            "projection-contract",
            (sys.executable, "studio/checks/audit_projection_contract.py"),
            "Validate the projection contract manifest and checked-in public projections.",
        ),
        CheckCommand(
            "studio-ready-state-audit",
            (sys.executable, "studio/checks/audit_studio_ready_state.py", "--strict"),
    ...
    "docs": (
        CheckCommand(
            ...
            pytest_argv(
                ...
                "studio/tests/python/test_docs_generated_reads.py",
                "studio/tests/python/test_docs_activity.py",
                "studio/tests/python/test_docs_live_rebuild_watcher.py",
                "studio/tests/python/test_docs_write_rebuild.py",
                "studio/tests/python/test_docs_management_mutations.py",
                "studio/tests/python/test_docs_management_service.py",
                "studio/tests/python/test_docs_management_routes.py",
                "studio/tests/python/test_docs_broken_links.py",
            ),
