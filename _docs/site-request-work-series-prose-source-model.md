...
- `_docs_catalogue/works/`
- `_docs_catalogue/series/`
...
- `_docs_catalogue/works/00008.md`
- `_docs_catalogue/series/067.md`
...
1. Permanent source roots are `_docs_catalogue/works/` and `_docs_catalogue/series/`.
...
- permanent source files are written to `_docs_catalogue/works/<work_id>.md` or `_docs_catalogue/series/<series_id>.md`
...
- work prose is read from `_docs_catalogue/works/<work_id>.md`
- series prose is read from `_docs_catalogue/series/<series_id>.md`
...
- permanent source now lives at `_docs_catalogue/works/00008.md`
