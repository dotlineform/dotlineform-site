...
| 12 | in-progress | `/docs/?mode=manage` | Metadata, import, settings, transient confirm/text/choice, and Docs HTML import filename-conflict modals | `_includes/docs_viewer_shell.html`, `assets/docs-viewer/js/docs-viewer-management.js`, `assets/docs-viewer/js/docs-viewer-management-modals.js`, `assets/docs-viewer/js/docs-html-import.js`, `assets/docs-viewer/js/docs-html-import-modals.js`, `assets/docs-viewer/css/docs-viewer-management.css` | Split in progress because of Docs Viewer portability and the old Docs Import page-include debt. First slice removed `_includes/docs_import_shell.html`, moved the import body into the Docs Viewer management modal shell, and aligned the filename-conflict modal with the portable `docsViewer__modal*` anatomy, default-width action row, focus return, and focus containment. Remaining before `done`: browser-check metadata, import, settings, transient confirm/text/choice, and filename-conflict states on desktop/mobile, then record the smoke command. |
