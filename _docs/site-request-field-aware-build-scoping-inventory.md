...
| `content_html` | Rendered work prose from `_docs_catalogue/works/<work_id>.md`. |
...
| `content_html` | Rendered series prose from `_docs_catalogue/series/<series_id>.md`. |
...
| `content_html` | Rendered moment prose from `_docs_catalogue/moments/<moment_id>.md`. |
...
- work prose: `_docs_catalogue/works/<work_id>.md`
- series prose: `_docs_catalogue/series/<series_id>.md`
