...
| Extract remaining catalogue write behavior out of the standalone HTTP handler. | Local Studio still reuses `catalogue_write_server.Handler` in-process for core editor mutations. | inventory done; extraction pending |
