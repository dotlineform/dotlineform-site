...
- permanent source lives under `_docs_catalogue/`
...
- permanent source root: `_docs_catalogue/moments/`
...
- permanent prose is written to `_docs_catalogue/moments/<moment_id>.md`
...
- generator moment prose lookup reads `_docs_catalogue/moments/<moment_id>.md`
...
- current external moment prose bodies were copied into `_docs_catalogue/moments/<moment_id>.md`
