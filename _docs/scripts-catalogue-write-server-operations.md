...
- `scripts/catalogue/catalogue_write_service.py` owns callable Local Studio service slices for delete preview, scoped build preview/apply, moment preview, prose import preview/apply, moment import preview/apply, work create, and work-detail create.
