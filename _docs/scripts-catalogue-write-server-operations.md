...
- `scripts/catalogue/catalogue_write_service.py` owns the first callable Local Studio service slice for delete preview, scoped build preview/apply, moment preview, prose import preview/apply, and moment import preview/apply.
