...
- outcome: changed the normal collision recovery flow to a `File already exists` modal with a full-width `doc_id` input seeded from the colliding id, OK for `replacement_doc_id`, Replace for explicit overwrite, and Cancel to leave the import unwritten. The staged-file control now occupies half the content width on desktop so the `publish into` field sits beside it.
- files changed:
  ...
  - `_docs/studio-ui-rules.md`
- local verification:
  - smoke `/studio/docs-import/` on desktop and mobile and confirm filename collisions open the modal, OK submits the edited `doc_id`, Replace overwrites the existing file, Cancel closes without writing, and the desktop controls keep the staged-file field at half width with `publish into` beside it
...
- files changed:
  ...
  - `_docs/refine-search.md`
  - `_docs/ui-pattern-column-links.md`
  - `_docs/studio-ui-rules.md`
- local verification:
  - build the Studio docs data and site
...
- files changed:
  ...
  - `assets/studio/css/studio.css`
  - `_docs/ui-pattern-reopenable-command-result.md`
  - `_docs/ui-pattern-column-links.md`
  - `_docs/ui-catalogue.md`
  - `_docs/studio-ui-rules.md`
- local verification:
  - build the Studio docs data and site
...
- files changed:
  ...
  - `_docs/library-import-ui.md`
  - `_docs/library-import.md`
  - `_docs/config-studio-config-json.md`
  - `_docs/studio-ui-rules.md`
- local verification:
...
- files changed:
  ...
  - `tests/smoke/data_import.py`
  - `_docs/library-import.md`
  - `_docs/library-import-export-v2.md`
  - `_docs/studio-ui-rules.md`
- local verification:
...
- files changed:
  ...
  - `_docs/catalogue-work-editor.md`
  - `_docs/catalogue-work-detail-editor.md`
  - `_docs/scripts-catalogue-write-server.md`
- verification:
...
- files changed:
  ...
  - `assets/studio/js/catalogue-series-editor.js`
  - `assets/studio/data/studio_config.json`
  - `_docs/catalogue-series-editor.md`
  - `_docs/catalogue-work-editor.md`
  - `_docs/scripts-catalogue-write-server.md`
- verification:
...
- verification:
  ...
  - preview/apply the import panel on `/studio/catalogue-moment/` and confirm import writes draft source only, opens the imported draft, and leaves publication to the editor `Publish` command
...
- files changed:
  ...
  - `_docs/catalogue-work-editor.md`
  - `_docs/scripts-catalogue-write-server.md`
  - `_docs/scripts-build-catalogue-json.md`
  - `_docs/studio-ui-rules.md`
- local verification:
...
- files changed:
  ...
  - `_docs/studio-runtime.md`
  - `_docs/user-guide.md`
  - `_docs/studio-e2e-checklist.md`
  - `_docs/site-request-catalogue-series-unified-editor.md`
  - `_docs/studio-ui-rules.md`
- local verification:
...
- files changed:
  ...
  - `assets/studio/data/studio_config.json`
  - `_docs/catalogue-work-detail-editor.md`
  - `_docs/site-request-catalogue-work-detail-unified-editor.md`
  - `_docs/studio-ui-rules.md`
- local verification:
...
- files changed:
  ...
  - `assets/studio/js/studio-config.js`
  - `_docs/catalogue-work-editor.md`
  - `_docs/site-request-catalogue-work-unified-editor.md`
  - `_docs/studio-ui-rules.md`
- local verification:
...
- outcome: added `/studio/project-state/`, a `Project State` Catalogue dashboard link, a local catalogue-server endpoint, and a script that writes `_docs/project-state.md`. The page now includes a default-off `include sub-folders` checkbox for adding `/projects/<project_folder>/<sub-folder>` entries to the report. Work details remain out of scope and detail folders are skipped by the report.
- files changed:
  ...
  - `_docs/project-state-page.md`
  - `_docs/scripts-project-state-report.md`
  - `_docs/scripts-catalogue-write-server.md`
  - `_docs/studio-ui-rules.md`
- local verification:
  - run the report script with `--write` and confirm it writes `_docs/project-state.md`
...
- files changed:
  ...
  - `assets/studio/data/studio_config.json`
  - `scripts/studio/catalogue_write_server.py`
  - `_docs/site-request-work-owned-files-links.md`
  - `_docs/catalogue-work-editor.md`
  - `_docs/user-guide.md`
...
- outcome: file/link source metadata is work-owned, file/link lifecycle status is retired, file/link add/edit/delete runs in the work editor, and the standalone pages/scripts/source JSON files have been removed.
- files changed:
  ...
  - `_docs/site-request-work-owned-files-links.md`
  - `_docs/catalogue-work-editor.md`
  - `_docs/data-models-catalogue.md`
  - `_docs/scripts-generate-work-pages.md`
  - `_docs/scripts-catalogue-write-server.md`
  - `_docs/catalogue-status.md`
  - `_docs/site-change-log.md`
  - `_docs/studio-ui-rules.md`
...
- issue: the work and series forms still exposed legacy prose filename fields after prose publication moved to ID-derived `_docs_catalogue/` Markdown.
...
- outcome: the import scope selector now includes `analysis`, the page preserves `?scope=analysis`, the HTML import helper accepts `_docs_analysis`, and new Analysis imports follow Library import defaults with `published: true` and `viewable: false` for manage-mode review.
- files changed:
  - `assets/studio/js/docs-html-import.js`
  - `assets/studio/data/studio_config.json`
  - `scripts/docs/docs_html_import.py`
...
- files changed:
  - `assets/js/docs-viewer.js`
  - `scripts/docs/docs_management_server.py`
  - `_docs/docs-viewer-management.md`
  - `_docs/scripts-docs-management-server.md`
  - `_docs/ui-framework.md`
  - `_docs/studio-ui-rules.md`
- local verification:
...
- files changed:
  ...
  - `assets/css/main.css`
  - `assets/studio/data/studio_config.json`
  - `_docs/ui-request-docs-viewer-index-drag-undo-task.md`
  - `_docs/docs-viewer-management.md`
  - `_docs/ui-framework.md`
  - `_docs/studio-ui-rules.md`
- local verification:
...
- permanent rule: Studio UI audit docs must include explicit `Remediation Status` and `Open Decisions` sections. Keep post-audit remediation and unresolved decisions in the audit doc itself. Use [Site Change Log](/docs/?scope=studio&doc=site-change-log) only for significant implemented outcomes, and promote items into [Change Requests](/docs/?scope=studio&doc=change-requests) only when they become real shared design/spec tasks.
- enforcement point: `_docs/studio-ui-conformance.md`, `_docs/ui-audits.md`
- files changed:
...
- enforcement point: `assets/studio/css/studio.css`, `_docs/studio-ui-framework.md`, `_includes/ui_catalogue_notes/input.md`
- files changed:
  - `assets/studio/css/studio.css`
  - `_docs/studio-ui-framework.md`
  - `_includes/ui_catalogue_notes/input.md`
...
- enforcement point: `_docs/studio-ui-conformance.md`
- files changed:
  - `_docs/studio-ui-conformance.md`
  - `_docs/studio-ui-rules.md`
  - `_docs/site-change-log.md`
...
- enforcement point: `_docs/ui-audits.md` and `_docs/studio-ui-conformance.md`
- files changed:
  - `_docs/ui-audits.md`
  - `_docs/studio-ui-conformance.md`
  - `_docs/design.md`
  - `_docs/studio-ui-start.md`
  - `_docs/site-docs.md`
  - `_docs/studio-ui-rules.md`
  - `_docs/site-change-log.md`
- local verification:
...
- enforcement point: `_docs/studio-ui-conformance.md`, plus signposting from `design.md`, `studio-ui-start.md`, `ui-catalogue.md`, and `studio-ui-framework.md`
- files changed:
  - `_docs/studio-ui-conformance.md`
  - `_docs/design.md`
  - `_docs/studio-ui-start.md`
...
- enforcement point: `studio/catalogue-work-file/index.md`, `studio/catalogue-work-link/index.md`, `studio/catalogue-series/index.md`, the matching runtime/config files under `assets/studio/`, and the three editor docs under `_docs/`
- files changed:
  - `studio/catalogue-work-file/index.md`
  - `studio/catalogue-work-link/index.md`
  - `studio/catalogue-series/index.md`
  ...
  - `assets/studio/js/catalogue-work-link-editor.js`
  - `assets/studio/js/catalogue-series-editor.js`
  - `_docs/catalogue-work-file-editor.md`
  - `_docs/catalogue-work-link-editor.md`
  - `_docs/catalogue-series-editor.md`
  - `_docs/studio-ui-rules.md`
  - `_docs/site-change-log.md`
- local verification:
...
- enforcement point: `studio/catalogue-series/index.md`, `assets/studio/js/catalogue-series-editor.js`, `assets/studio/data/studio_config.json`, `assets/studio/js/studio-config.js`, and `_docs/catalogue-series-editor.md`
- files changed:
  - `studio/catalogue-series/index.md`
  - `assets/studio/js/catalogue-series-editor.js`
  - `assets/studio/data/studio_config.json`
...
- enforcement point: `studio/catalogue-work-detail/index.md`, `assets/studio/data/studio_config.json`, `assets/studio/js/studio-config.js`, `assets/studio/js/catalogue-work-detail-editor.js`, and `_docs/catalogue-work-detail-editor.md`
- files changed:
  - `studio/catalogue-work-detail/index.md`
  - `assets/studio/data/studio_config.json`
  - `assets/studio/js/studio-config.js`
...
- enforcement point: `studio/catalogue-work/index.md`, `assets/studio/js/catalogue-work-editor.js`, `assets/studio/data/studio_config.json`, `assets/studio/js/studio-config.js`, `assets/studio/css/studio.css`, and `_docs/catalogue-work-editor.md`
- files changed:
  - `studio/catalogue-work/index.md`
  - `assets/studio/js/catalogue-work-editor.js`
  - `assets/studio/data/studio_config.json`
...
- enforcement point: `studio/catalogue-work/index.md`, `assets/studio/data/studio_config.json`, `assets/studio/js/studio-config.js`, `assets/studio/js/catalogue-work-editor.js`, and `_docs/catalogue-work-editor.md`
- files changed:
  - `studio/catalogue-work/index.md`
  - `assets/studio/data/studio_config.json`
  - `assets/studio/js/studio-config.js`
...
- status: adopted
- route: `/studio/analytics/series-tag-editor/`, `/studio/ui-catalogue/button/`
...
- enforcement point: `studio/analytics/series-tag-editor/index.md`, `studio/ui-catalogue/button/index.md`, `_includes/studio_ui_catalogue_button_demo.html`, `_includes/ui_catalogue_notes/button.md`, and the button/message guidance in `studio-ui-framework.md`
- files changed:
  ...
  - `_docs/site-change-log.md`
- local verification:
  - inspect `/studio/analytics/series-tag-editor/` on desktop and mobile and confirm the feedback row sits directly below the `Add` / `Save` row inside the editor panel
...
- enforcement point: `studio/analytics/series-tag-editor/index.md`, `studio/ui-catalogue/button/index.md`, and `_includes/ui_catalogue_notes/button.md`
- files changed:
  - `studio/analytics/series-tag-editor/index.md`
  - `studio/ui-catalogue/button/index.md`
  - `_includes/studio_ui_catalogue_button_demo.html`
  ...
  - `_docs/site-change-log.md`
- local verification:
  - inspect `/studio/analytics/series-tag-editor/` and confirm `Add` and `Save` are the same default width beside the tag field
...
- enforcement point: `ui-catalogue.md`, primitive docs under `_docs/`, and shared primitive CSS when the failure is systemic
- files changed:
  - `_docs/ui-catalogue.md`
  - `_docs/studio-ui-framework.md`
  - `_docs/studio-ui-rules.md`
