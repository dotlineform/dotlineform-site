...
Gallery creation/title editing and bulk Work creation from selected images remain separate capabilities. No Detail-specific browser, modal or service is retained for that future work. Shared file-picker, record-list, modal and media-preview components remain available.
