...
The two report tables cover registered Docs Viewer reports, shared collection-report list/detail controls, report-owned menus and row/header cues. The Catalogue Works report is included; the separate Studio Catalogue application's Works editor has its own [mapping table](d-20260924-120657-a61d92.md). Shared viewer controls displayed above a report, such as Edit document and VS Code, remain in the first table and are not duplicate report-owned controls.
