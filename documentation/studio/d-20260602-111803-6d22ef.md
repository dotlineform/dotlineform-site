...
| --- | --- | --- | --- | --- |
| `studio_home` | `/studio/` | `studio-home.html` | `studio-home.js` | Work editor and field registry |
...
Document browsing happens in Docs Viewer. Studio home opens the Work editor and field registry. Gallery editing and bulk Work creation from selected images remain separate future work.
