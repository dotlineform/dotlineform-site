...
| --- | --- | --- | --- | --- |
| `studio_home` | `/studio/` | `studio-home.html` | `studio-home.js` | Catalogue editors and field registry |
...
| `catalogue_work_editor` | `/studio/catalogue-work/` | `catalogue-work.html` | `catalogue-work-editor.js` | Work creation, single/bulk editing, resources and media selection |

Template paths are rooted under `studio/app/frontend/routes/`; scripts are under `studio/app/frontend/js/`.

There are no Work Detail or Moment editor routes in the current registry. The embedded Detail browser and section-entry workflow are retired, and there is no current public Moment route.

Document browsing happens in Docs Viewer. Studio home opens the Work editor, Series editor and field registry. Gallery editing and bulk Work creation from selected images belong to a separate Works/Series editor delivery.
