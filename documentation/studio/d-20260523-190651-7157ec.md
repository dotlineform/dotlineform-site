...
- [ ] For a [Planned](/docs/?scope=studio&doc=d-20260428-000000-f5ff18) feature delivery, keep the initial readiness step read-only and concise. Exact file inventories, line estimates, frozen code, fixtures, prototypes, generated deltas, and complete test architecture are implementation work, not approval prerequisites.
...
- [ ] Keep the test specification and current coverage record under Testing or its durable app/domain owner, outside delivery documents, following [Test Contract Discipline](/docs/?scope=studio&doc=d-20260627-212121-7cf7de). Record exact selectors/membership, scenarios, inputs, assertions, fixtures/mocks, real systems, side effects, exclusions, commands/triggers, and costs. A delivery links to that record; it does not become the test's only documentation.
