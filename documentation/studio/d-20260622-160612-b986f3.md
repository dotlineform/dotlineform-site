...
Retired by the Gallery conversion on 2026-09-23. This document describes the old migration input. The runtime rejects these aggregate files; converted images are independent Works, with Gallery identity and membership owned by the sources described in [Catalogue Source Model](d-20260519-000000-a0da45.md). Remaining Detail consumer/editor code is removed or repurposed through the later Gallery output, token and UI steps.
...
This structure matches the [Catalogue Work Editor](/docs/?scope=studio&doc=d-20260422-000000-45a776): detail sections are created, browsed, and deleted as Work-owned aggregates rather than as independent Studio records.
