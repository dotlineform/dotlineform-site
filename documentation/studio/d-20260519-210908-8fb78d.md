...
Those are local-only requirements because the Catalogue generators and media pipeline run on your machine before the generated artifacts are committed.
