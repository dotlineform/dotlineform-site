---
draft: false
doc_id: d-20260607-222033-c0b57a
...
Common Title/Summary editing is owned by the combined Source session and `/docs/source/save`, described in [Source Editor Scripts](d-20260607-222033-704641.md). The old metadata modal, `/docs/update-metadata` route and its planner are removed. Index placement and focused Subject/Draft mutations retain their separate owners; Source Save does not invoke their rebuild follow-through.
...
- logs completed focused mutation actions when plans request it
...
Purpose: mutation planner for source document creation, focused field actions, placement and deletion.
