...
function renderToggle(button, theme) {
  ...
  button.querySelectorAll("[data-ui-catalogue-theme-icon]").forEach((icon) => {
    if (icon.dataset.uiCatalogueThemeIcon === activeTheme) {
...
function initUiCatalogueThemeToggle(options = {}) {
  ...
  const buttons = Array.from(root.querySelectorAll("[data-ui-catalogue-theme-toggle]"));
