    ...
    "quick": (
        ...
        CheckCommand(
            ...
            (
                ...
                "docs-viewer/services/docs_document_archive.py",
                "docs-viewer/services/docs_document_archive_apply.py",
    ...
    "docs": (
        ...
        CheckCommand(
            ...
            pytest_argv(
                ...
                "docs-viewer/tests/python/test_docs_document_archive.py",
