...
def main(argv: list[str] | None = None) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="dlf-docs-scope-ui-") as tmp_dir:
        ...
        try:
            ...
            manifest_path = fixture_root / "scripts" / "docs" / "docs_scope_manifest.json"
            ...
            print(f"local Studio Docs scope lifecycle UI OK: {base_url}/docs/?scope=studio&doc=root-doc&mode=manage")
            return 0
        finally:
            server.shutdown()
            server.server_close()
