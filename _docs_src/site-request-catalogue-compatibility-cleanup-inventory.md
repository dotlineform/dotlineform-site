...
| Deprecated script cleanup | scan Python scripts for retired workbook references; `./scripts/run_checks.py --profile quick` | Confirm script docs route users to current JSON-source commands |
