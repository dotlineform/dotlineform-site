...
| media copy/srcset | `copy_draft_media_files.py`, `make_srcset_images.sh`, orchestrated by `build_catalogue.py` | same scripts, run as separate local actions or explicit build actions |
