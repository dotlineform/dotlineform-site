...
I added a repeatable audit script at `scripts/css_token_audit.py`, generated the current snapshot in [docs/css-audit-latest.md](/docs/css-audit-latest/), and documented it in [docs/scripts-overview.md](/docs/scripts-overview/). Verification was just the script run: `python3 scripts/css_token_audit.py`.
...
4. Re-run [docs/css-audit-latest.md](/docs/css-audit-latest/) and only then start the color pass.
