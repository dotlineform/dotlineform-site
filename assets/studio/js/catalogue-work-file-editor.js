...
async function init() {
  ...
  try {
    ...
    buildButton.addEventListener("click", () => {
      buildCurrentWork(state).catch((error) => console.warn("catalogue_work_file_editor: unexpected build failure", error));
    });
