const DEFAULT_STUDIO_CONFIG = {
  ...
  ui_text: {
    ...
    catalogue_work_editor: {
      ...
      save_result_success: "Source saved at {saved_at}. Rebuild needed to update public catalogue.",
      save_result_unchanged: "Source already matches the current form values.",
      build_preview_template: "Build preview: work {work_ids}; series {series_ids}; catalogue search {search_rebuild}.",
      build_preview_search_yes: "yes",
      build_preview_search_no: "no",
      build_preview_failed: "Build preview unavailable.",
      build_status_running: "Running scoped rebuild…",
      build_status_success: "Scoped rebuild completed.",
      build_status_failed: "Scoped rebuild failed.",
      build_result_success: "Runtime rebuilt at {completed_at}. Build Activity updated.",
    ...
    catalogue_moment_import: {
      ...
      context_hint: "Enter a moment markdown filename from the canonical moments source folder. This page previews the existing file and then runs a targeted import/rebuild for that one moment.",
      ...
      file_description: "filename only; the source file is resolved from the canonical moments folder",
      ...
      source_summary: "This workflow reads metadata from the existing source markdown file. Edit the source file directly when prose or front matter needs to change.",
    ...
    catalogue_work_detail_editor: {
      ...
      save_status_failed: "Source save failed.",
      save_result_success: "Source saved at {saved_at}. Rebuild needed to update the parent work output.",
      save_result_unchanged: "Source already matches the current form values.",
      build_preview_template: "Build preview: work {work_ids}; series {series_ids}; catalogue search {search_rebuild}.",
      build_preview_search_yes: "yes",
      build_preview_search_no: "no",
