const DEFAULT_STUDIO_CONFIG = {
  ...
  ui_text: {
    series_tag_editor: {
      ...
      save_status_local_failed: "Local save failed. Switched to Patch mode.",
      save_result_local_failed: "Local server save failed. Showing patch fallback.",
