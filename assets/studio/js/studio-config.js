const DEFAULT_STUDIO_CONFIG = {
  ...
  ui_text: {
    ...
    catalogue_new_series_editor: {
      ...
      save_mode_local_server: "Local server",
      save_mode_offline: "Unavailable",
      context_hint: "Create a draft series first. Add member works and primary_work_id in the series editor after save.",
      save_mode_unavailable_hint: "Local catalogue server unavailable. Create is disabled.",
      dirty_warning: "Unsaved draft series metadata.",
      field_required_series_id: "Enter a series id.",
      field_duplicate_series_id: "Series id already exists.",
      field_required_title: "Enter a title.",
      field_required_series_type: "Choose a series type.",
      ...
      field_invalid_year: "Use a whole year or leave blank.",
      field_required_year_display: "Enter a year display.",
      suggested_series_id: "Suggested next id: {series_id}.",
      draft_summary: "New series are saved as draft. After create, open the series editor to add member works, set primary_work_id, and run rebuild.",
      create_status_validation_error: "Fix validation errors before creating the draft series.",
      create_status_saving: "Creating draft series…",
      create_status_success: "Created draft series {series_id}.",
      create_status_failed: "Draft series create failed.",
      create_result_success: "Created draft series {series_id}. Opening series editor…"
    },
    search: {
