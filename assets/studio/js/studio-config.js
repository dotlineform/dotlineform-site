const DEFAULT_STUDIO_CONFIG = {
  ...
  ui_text: {
    ...
    library_export: {
      ...
      idle_status: "Select documents for the export, then run the export.",
      ...
      result_counts_label: "counts",
      result_counts: "{exported} exported; {skipped} skipped; {truncated} truncated.",
