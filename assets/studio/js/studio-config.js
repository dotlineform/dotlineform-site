const DEFAULT_STUDIO_CONFIG = {
  ...
  "ui_text": {
    "series_tag_editor": {
      ...
      "modal_title": "Tag Assignment Patch Preview",
      "modal_resolved_label": "Resolved tag assignment payload",
      ...
      "select_work_before_tags": "Select a work before adding tags.",
      ...
      "save_status_copy_failed": "Copy failed. Select and copy the patch guidance manually.",
    ...
    "docs_html_import": {
      "intro": "Import staged source files into the Studio, Analysis, or Library docs source.",
      "file_label": "staged file",
      "scope_label": "publish into",
      "scope_option_studio": "studio",
      "scope_option_analysis": "analysis",
      "scope_option_library": "library",
      "include_prompt_meta_label": "Include obvious prompt/meta blocks",
      "include_prompt_meta_hint": "When enabled, clearly identifiable prompt/meta sections are kept as wrapped quoted prose.",
      "import_button": "Import",
      "confirm_overwrite_button": "Confirm overwrite",
      "cancel_overwrite_button": "Cancel",
      "service_unavailable": "Docs management service unavailable. Start bin/dev-studio to run imports.",
      "loading": "loading docs import…",
      "idle_status": "Select a staged source file and import it into Studio, Analysis, or Library docs.",
      "running_status": "Converting and validating staged source…",
      "load_files_failed": "Failed to load staged import files.",
      "no_files": "No supported staged import files found under var/docs/import-staging/.",
      "file_required": "Select a staged file first.",
      ...
      "result_operation_create": "Created new doc",
      "result_operation_overwrite": "Overwrote existing doc",
      "result_scope": "scope",
      "result_doc_id": "doc_id",
      "result_title_label": "title",
      "result_source": "source",
      "result_viewer": "viewer",
      "result_backup": "backup",
      "result_media_source": "staged media",
      "result_media_key": "R2 key",
      "result_media_token": "media link",
      "result_open_viewer": "Open viewer",
      "result_open_source_failed": "Failed to open source doc.",
      ...
      "collision_body": "This import matches an existing doc target. Confirm overwrite to replace the current source while keeping the same doc identity and filename.",
      "filename_conflict_heading": "File already exists",
      "filename_conflict_body": "A source file named {doc_id}.md already exists. Edit the doc_id to choose a new filename.",
      ...
      "replacement_doc_id_required": "Enter a doc_id first.",
      "replacement_title_heading": "File already exists",
      "replacement_title_body": "This staged file matches an existing doc filename. Enter a replacement doc_id, then run import again.",
      "replacement_title_meta": "Existing doc_id: {doc_id}.",
      "replacement_title_label": "doc_id",
      "replacement_title_required": "Enter a doc_id first."
    },
    "catalogue_status": {
    ...
    "project_state": {
      ...
      "server_unavailable_hint": "Local catalogue server unavailable. Report generation is disabled.",
      "docs_server_unavailable_hint": "Local docs-management server unavailable. Opening the Markdown file is disabled.",
      ...
      "open_failed": "Could not open the Markdown source file."
    },
    "bulk_add_work": {
    ...
    "tag_groups": {
      "load_failed_error": "Failed to load group descriptions from /assets/studio/data/tag_groups.json.",
...
function warnScopedTextFallback(group, detail) {
  ...
  console.warn(`studio_config: scoped ui_text.${group} unavailable; using bundled/fallback copy`, detail);
}
