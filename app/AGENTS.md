...
- Apply the repository-root test specification, approval, durable coverage documentation, and resource-budget policy to Swift and service tests alike. The commands below are recipes for justified checks, not automatic requirements after each edit.
