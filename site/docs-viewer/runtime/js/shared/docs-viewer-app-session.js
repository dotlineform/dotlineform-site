...
function createManagementTextDefaults() {
  return {
    ...
    scopePublicReadonlyModeNote: "Creates a source root, scope config, read-only route, manifest record, and generated outputs.",
    scopeLocalCommittedModeNote: "Creates tracked source, config, manifest, and non-public generated outputs under docs-viewer/generated/. No public route is created.",
    scopeLocalExternalModeNote: "Creates a repo-registered local scope whose source and generated JSON live under an external data root. No public route is created.",
